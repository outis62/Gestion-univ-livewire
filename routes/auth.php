...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/reset_password', [PasswordResetLinkController::class, 'index'])->name('reset_password');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/reset_password', [PasswordController::class, 'resetPassword'])->name('reset_password');
