        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Nouveau mode d'acquisition</h4>

                </div><!-- end card header -->

                <div class="card-body">
                    <div class="live-preview">
                        <form class="row g-3" action="{{ route('mode-acquisition.store') }}" method="POST">
                            @csrf
                            <div class="col-md-6">
                                <label for="validationDefault01" class="form-label">Intitule</label>
                                <input type="text" class="form-control" id="validationDefault01" name="libelle" required>
                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault02" class="form-label">Auteur</label>
                                <input type="text" class="form-control" id="validationDefault02" name="auteur" required>
                            </div>
