<!-- Modal -->
<div class="modal fade zoomIn" id="deleteRecordModal{{ $moyenStockage->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('moyen-stockage.destroy', $moyenStockage->id) }}" method="POST">
                @csrf
                @method('DELETE')
